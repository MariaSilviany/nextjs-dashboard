    ...
    <div className="min-h-screen bg-gray-900 pt-[130px] font-sans">
      ...
      <div className="bg-[#cbd5e1] text-black rounded-lg mx-auto my-8 p-8 max-w-5xl flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2">
          <h1 className={`text-4xl font-bold text-red-700 ${jollyLodger.className}`}>Kafan Arwah Kelam</h1>
          <div className="flex items-center gap-2 mt-2">
            <span className={`text-black text-xl ${nosifer.className}`}>Rp 350.000</span>
          ...
          <p className="mt-6 text-justify leading-relaxed italic">
            Eksplorasi konsep kematian dalam bentuk kain kafan modern—“Kafan Arwah Kelam” menghadirkan kombinasi warna hitam dan putih sebagai simbol keseimbangan antara cahaya dan kegelapan. Didesain untuk pertunjukan seni, film pendek bertema spiritual atau horor, serta dekorasi tematik bagi para penikmat nuansa gothic dan simbolisme metafisik.
          </p>
          <p className="mt-4 text-justify leading-relaxed italic">
            Diletakkan di atas keranda bambu klasik, produk ini menyampaikan narasi kuat tentang transisi, misteri, dan kesunyian abadi.
          </p>
          <div className="mt-6">
            <h2 className="text-2xl font-semibold mb-2 italic">Spesifikasi Produk:</h2>
            <div className="text-left space-y-2 italic">
                <p>Material: Katun premium & serat linen kombinasi</p>
                <p>Warna: Dual-tone (Putih & Hitam)</p>
                <p>Ukuran: All size (dapat disesuaikan/panjang 2 meter)</p>
                <p>Bonus: Tali pembungkus dan petunjuk pengikatan artistik</p>
                <p>Kegunaan: Properti seni panggung, teater, pemotretan, dekorasi tematik</p>
            </div>
            </div>
        </div>
      </div>
