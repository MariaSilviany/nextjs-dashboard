    ...
    <div className="min-h-screen bg-gray-900 pt-[130px] font-sans">
      ...
      <div className="bg-[#cbd5e1] text-black rounded-lg mx-auto my-8 p-8 max-w-5xl flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2">
          <h1 className={`text-4xl font-bold text-red-700 ${jollyLodger.className}`}>Cermin</h1>
          <div className="flex items-center gap-2 mt-2">
            <span className={`text-black text-xl ${nosifer.className}`}>Rp 50.000</span>
          ...
          <p className="mt-6 text-justify leading-relaxed italic">
            Cermin ini memantulkan lebih dari sekadar bayangan ia menangkap getaran dari dimensi lain. Dalam pantulannya, konon arwah penasaran sering menampakkan diri pada mereka yang cukup berani menatap lebih lama dari seharusnya.
          </p>
          <p className="mt-4 text-justify leading-relaxed italic">
            Dengan bingkai usang berornamen gotik dan permukaan yang sedikit berembun, cermin ini dirancang bukan hanya sebagai dekorasi, tetapi sebagai gerbang simbolis menuju dunia yang tak terlihat.
          ...
          <div className="mt-6">
            ...
            <div className="text-left space-y-2 italic">
                <p>Material:  Kaca antik dengan bingkai kayu ukir tangan</p>
                <p>Warna: Hitam pekat dengan detail perak lusuh</p>
                <p>Ukuran:  25 cm x 35 cm</p>
                <p>Bonus: Kain penutup beludru hitam & kartu instruksi “Ritual Tatapan 13 Detik”</p>
                <p>Kegunaan: Dekorasi tematik, alat teater atau pemotretan horor, koleksi pribadi penggemar metafisika</p>
            </div>
            </div>
        </div>
      </div>
