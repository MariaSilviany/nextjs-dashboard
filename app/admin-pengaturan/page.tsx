      ...
      >
        ...
        >
          <SettingSection title="Pengaturan Umum">
            <SettingItem title="Nama Toko" value="Ubah nama toko yang ditampilkan" buttonText="Ubah" />
            <SettingItem title="Logo Toko" value="Ganti logo toko (Rekomendasi 200x50px)" buttonText="Ubah" />
          ...
          <SettingSection title="Pengaturan Notifikasi">
            <SettingItem title="Email Notifikasi" value="Atur email untuk notifikasi sistem" buttonText="Ubah" />
            <SettingItem title="Notifikasi WhatsApp" value="Atur nomor WhatsApp untuk notifikasi" buttonText="Ubah" />
          </SettingSection>

          <SettingSection title="Keamanan">
            <SettingItem title="Kata Sandi" value="Ubah kata sandi admin" buttonText="Ubah" />
            <SettingItem
              title="Autentifikasi Dua Faktor"
              value={
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div style={{ flex: 1 }}>
          <span style={{ fontWeight: 'bold', color: '#E2E8F0', fontSize: '1rem' }}>{title}</span>
          {typeof value === 'string' && (
            <p style={{ margin: '5px 0 0', color: '#A0AEC0', fontSize: '0.875rem' }}>{value}</p>
          )}
        </div>
        {buttonText && (
          <button
            style={{
              ...
              borderWidth: '1px',
              borderStyle: 'solid',
              borderColor: buttonStyle?.backgroundColor || '#4F46E5',
