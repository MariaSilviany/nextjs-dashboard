...
export default function AdminDashboard() {
  const penjualanTerakhir = await prisma.produk.findMany({
    orderBy: { stok: 'asc' },
    take: 3,
  });
    ...
    <div className="flex min-h-screen bg-[#1e2a3e]">
      ...
      <div className="flex-1 pl-56 p-6 ">
        ...
        <div className="bg-[#B9BFC7] p-6 rounded-lg mb-6 items-start mx-auto ml-8 mt-10">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 text-gray-800 ${nunitoSans.className}`}>
            {/* Total Produk Terjual */}
            <div className="bg-white rounded-xl p-5 shadow-md">
              <h4 className="text-xl font-bold mb-2">Total Produk Terjual</h4>
              <p className="text-3xl font-semibold">6 Pcs</p> {/* Gantilah dengan value dinamis */}
            </div>

            {/* Total Revenue */}
            <div className="bg-white rounded-xl p-5 shadow-md">
              <h4 className="text-xl font-bold mb-2">Total Revenue</h4>
              <p className="text-3xl font-semibold">Rp396.000</p> {/* Gantilah dengan value dinamis */}
            </div>

            {/* Produk Terlaris */}
            <div className="bg-white rounded-xl p-5 shadow-md">
              <h4 className="text-xl font-bold mb-2">Produk Terlaris</h4>
              <p className="text-3xl font-semibold">Lilin Aroma Misterius (4 Pcs)</p> {/* Gantilah dengan value dinamis */}
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#B9BFC7] p-6 rounded-lg mb-6 items-start mx-auto ml-8 mt-10">
          <h3 className={`text-5xl text-red-900 mb-4 ${jollyLodger.className}`}>Penjualan Terakhir</h3>
