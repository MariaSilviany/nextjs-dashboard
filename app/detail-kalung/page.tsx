    ...
    <div className="min-h-screen bg-gray-900 pt-[130px] font-sans">
      ...
      <div className="bg-[#cbd5e1] text-black rounded-lg mx-auto my-8 p-8 max-w-5xl flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2">
          <h1 className={`text-4xl font-bold text-red-700 ${jollyLodger.className}`}>Kalung Perak Anti Kutukan</h1>
          <div className="flex items-center gap-2 mt-2">
            <span className={`text-black text-xl ${nosifer.className}`}>Rp 150.000</span>
          ...
          <p className="mt-6 text-justify leading-relaxed italic">
            Diukir dengan simbol kuno dari kitab pelindung abad pertengahan, kalung ini dipercaya mampu menolak energi negatif dan membungkam bisikan terkutuk dari alam bawah. Dipakai oleh penjaga gerbang mimpi dan pemburu entitas gaib, Kalung Perak Anti Kutukan bukan sekadar perhiasan ia adalah pelindung spiritual yang bertahta.
          </p>
          <p className="mt-4 text-justify leading-relaxed italic">
            Didesain dengan sentuhan gothic dan sentral liontin ukiran gelap, kalung ini sangat cocok untuk peminat gaya alternatif, seniman panggung, atau kolektor benda mistis.

          </p>
          <div className="mt-6">
            <h2 className="text-2xl font-semibold mb-2 italic">Spesifikasi Produk:</h2>
            <div className="text-left space-y-2 italic">
                <p>Material:  Rantai baja hitam + liontin perak ukir simbol warding</p>
                <p>Warna: Perak pudar & hitam pekat</p>
                <p>Ukuran:  Panjang rantai ± 50 cm (unisex)</p>
                <p>Bonus: Kartu mantra pengaktifan & pouch hitam beludru</p>
                <p>Kegunaan: Aksesori fashion gothic, properti seni horor, koleksi benda spiritual</p>
            </div>
            </div>
        </div>
      </div>
