...
const TambahTim: React.FC = () => {
  ...
  return (
     ...
     <div className="flex-1 bg-gray-50 flex justify-center items-center ml-56">
        ...
        <div className={`rounded px-6 py-2 bg-[#1f3447] text-white p-4 text-center text-2xl font-bold mb-8 ${creepster.className}`}>
          TAMBAH TIM
        </div>
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center mb-8">
              <div className="flex flex-col items-center">
                ...
                <div className="text-center mt-3">
                  ...
                  <label className="inline-block bg-white border border-gray-300 rounded-md px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 cursor-pointer">
                    <i className="fas fa-upload mr-2"></i> Unggah Foto
                    <input
                      type="file"
                      className="hidden"
                      accept="image/*"
            ...
            <div className="grid grid-cols-2 gap-8">
              {/* Left Column - Nama, Email, Tanggal */}
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border bg-gray-50 border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-900"
                    placeholder="Masukkan nama lengkap"
                  />
                  {errors.namaLengkap && (
                    <p className="text-rose-500 text-xs mt-1">{errors.namaLengkap}</p>
                  )}
                </div>
              ...
              <div>
                <div>
                  ...
                  >
                    ...
                    <option value="Staff">CEO</option>
                    <option value="Staff">CFO</option>
                    <option value="Staff">CTO</option>
            ...
            <div className="border-t border-gray-200 mt-8 pt-6 flex justify-end space-x-3">
              <button
                type="button"
              ...
              <button
                type="submit"
                className="bg-gray-700 text-white py-2 px-6 rounded-md hover:bg-red-700"
              >
                Simpan
              </button>
            </div>
