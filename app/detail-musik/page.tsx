    ...
    <div className="min-h-screen bg-gray-900 pt-[130px] font-sans">
      ...
      <div className="bg-[#cbd5e1] text-black rounded-lg mx-auto my-8 p-8 max-w-5xl flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2">
          <h1 className={`text-4xl font-bold text-red-700 ${jollyLodger.className}`}>Kotak Musik Berhantu</h1>
          ...
          <p className="mt-6 text-justify leading-relaxed italic">
            Sebuah kotak musik kayu tua yang menyimpan harmoni lembut sekaligus menyeramkan. Denting nadanya seolah memanggil arwah yang terperangkap di antara waktu—terdengar indah di telinga, tapi menyisakan bisikan halus yang menggema dalam kesunyian.
          </p>
          <p className="mt-4 text-justify leading-relaxed italic">
            Dirancang sebagai properti spiritual, elemen teater horor, atau koleksi eksentrik bagi penggemar barang antik bertema gothic dan metafisika. Dibuka dengan kunci berukir lambang misterius, kotak ini memutar lagu berulang yang tidak ditemukan di katalog musik manapun.
          </p>
          <div className="mt-6">
            <h2 className="text-2xl font-semibold mb-2 italic">Spesifikasi Produk:</h2>
            <div className="text-left space-y-2 italic">
                <p>Material:  Kayu mahoni tua, logam antik, dan mekanisme musik manual</p>
                <p>Warna:  Coklat gelap & emas pudar</p>
                <p>Ukuran: Diameter 35 cm, tinggi 50 cm (dapat disesuaikan)</p>
                <p>Bonus: Kunci logam hias dan kertas narasi kisah “penghuni” kotak</p>
                <p>Kegunaan:  Properti teater, pemotretan, koleksi tematik, penghias altar gothic</p>
            </div>
            </div>
        </div>
      </div>
