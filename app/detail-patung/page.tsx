    ...
    <div className="min-h-screen bg-gray-900 pt-[130px] font-sans">
      ...
      <div className="bg-[#cbd5e1] text-black rounded-lg mx-auto my-8 p-8 max-w-5xl flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2">
          <h1 className={`text-4xl font-bold text-red-700 ${jollyLodger.className}`}>Patung Pemujaan Kuno</h1>
          ...
          <p className="mt-6 text-justify leading-relaxed italic">
            Dibentuk dari cetakan tanah ritual dan dilumuri ramuan alami yang menghitam seiring waktu, Patung Pemujaan Kuno adalah representasi entitas tanpa nama dari masa prasejarah spiritual. Arsitektur wajahnya yang retak dan sikap diamnya menyiratkan kekuatan tersembunyi penjaga batas antara dunia manusia dan dimensi yang terlupakan.
          </p>
          <p className="mt-4 text-justify leading-relaxed italic">
            Benda ini bukan sekadar ornamen. Ia adalah simbol penghormatan, sekaligus peringatan, akan sesuatu yang lebih besar dari logika.
          </p>
          <div className="mt-6">
            <h2 className="text-2xl font-semibold mb-2 italic">Spesifikasi Produk:</h2>
            <div className="text-left space-y-2 italic">
                <p>Material:  Campuran tanah liat keras, batu hitam, dan serpihan arang alami</p>
                <p>Warna:   Hitam arang & abu tanah kering</p>
                <p>Ukuran:  ± 30 cm</p>
                <p>Bonus: Potongan naskah mantra pemanggilan & alas kayu tua</p>
                <p>Kegunaan:  Properti pertunjukan horor, koleksi benda mistik, dekorasi altar tematik</p>
            </div>
            </div>
        </div>
      </div>
