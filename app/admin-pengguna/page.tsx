...
const AdminPengguna = () => {
  // Updated user data to match the image
  const users = [
    {
      id: 1,
      name: "Rangga",
          ...
          <table className="w-full border-collapse h-full">
              ...
              {users.map((user) => (
                    <tr key={user.id}>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="w-16 h-16 bg-gray-600 rounded flex items-center justify-center overflow-hidden">
                            <img className="h-16 w-16 rounded" src={user.avatar} alt="" />
                          </div>
                          <div className="ml-4">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-black">{user.role}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-black">{user.email}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-500 text-white">
                          {user.status}
                        </span>
                      </td>
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button className="p-1 text-red-400 hover:text-red-300" title="Hapus">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
            ...
            <div className="px-6 py-4 border-t border-gray-700 flex items-center justify-between">
              <p className="text-sm text-gray-400">
                Menampilkan 1-7 dari 180 pengguna
              </p>
              <div className="flex space-x-2">
                <button className="px-3 py-1 bg-gray-700 rounded text-gray-300 hover:bg-gray-600">
