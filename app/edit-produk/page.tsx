...
const EditProduk: React.FC = () => {
  ...
  if (!product) {
    return <div className="text-white">Produk tidak ditemukan</div>;
  }
  ...
  return (
    <div className="flex min-h-screen bg-[#1e2a3e]">
      ...
      <div className="flex-1 bg-gray-50 flex justify-center items-center ml-56">
        ...
        >
          <div
            className={`rounded px-6 py-2 bg-[#1f3447] text-white p-4 text-center text-2xl font-bold mb-8 ${creepster.className}`}
          >
            EDIT PRODUK
          </div>
          <form>
              ...
              <div>
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    className="w-40 h-10 px-3 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900"
                    min="0"
                  />
                ...
                <div className="mb-6">
                  ...
                  <div className="border-2 border-dashed border-gray-700 rounded-lg p-6 text-center">
                    ...
                    <p className="text-gray-900 mb-2">
                      Klik atau seret file gambar ke sini untuk mengganti
                    </p>
