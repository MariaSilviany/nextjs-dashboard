...
const HauntedHallowAdmin = () => {
  ...
  const renderProducts = (productText: string | null): React.ReactNode => {
    ...
    return products.map((product, index) => <div key={index}>{product}</div>);
  };
        ...
        <div className="flex justify-between items-center p-4 bg-[#1b2838] border-b border-gray-700 ">
          <div className="flex items-center w-full">
            ...
            <Link href="/tambah-produk" legacyBehavior>
              <a className="px-4 py-2 bg-red-600 text-white rounded flex items-center hover:bg-red-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="bg-gray-400 rounded shadow-lg overflow-hidden ">
              ...
              <tbody>
                {products.map((product) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-black">{product.position}</td>
                    <td className="p-4 text-black">{product.contact}</td>
                    <td className="p-4">
                      <span className="px-3 py-1 bg-green-500 text-black font-medium rounded-full text-sm">
                        {product.status}
                      </span>
                    </td>
                    <td className="p-4">
                      <div className="flex space-x-2">
                        <Link
                          href={`/edit-produk?id=${product.id}`}
                          legacyBehavior
                        >
                          <a className="p-1 text-green-400 hover:text-green-300">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-6 w-6"
                              fill="none"
            ...
            <div className="p-4 flex justify-end items-center">
              <span className="text-gray-800 mr-4">
                Menampilkan 1-7 dari 140 produk
              </span>
