...
const AdminPesanan = () => {
  ...
  const orders = [
    {
      id: "PSN001",
      customer: "Khatarina",
      products: "Topeng Hantu Horor(1 Pcs)",
      total: "Rp80.000",
      date: "01-03-2024 11:32",
      status: "Sedang Diproses",
    },
    {
      id: "PSN002",
      customer: "John Ferry",
      products: "Topeng Hantu Horor(1 Pcs)\nLilin Aroma Misterius(1 Pcs)",
      total: "Rp146.000",
      date: "06-09-2024 14:32",
      status: "Menunggu Pembayaran",
    },
    {
      id: "PSN003",
      customer: "Lusia Nadia",
      products: "Boneka Seram (1 Pcs)\nLilin Aroma Misterius(3 Pcs)",
      total: "Rp132.000",
      date: "25-09-2024 10:22",
      status: "Menunggu Pembayaran",
    },
    {
      id: "PSN004",
      customer: "Maria Iata",
      products: "Karlan Arwah Kela (1 Pcs)\nLampu Hias gantung(1 Pcs)",
      total: "Rp220.000",
      date: "30-04-2024 08:46",
      status: "Sedang Diproses",
    },
    {
      id: "PSN005",
      customer: "Lea Ginara",
      products: "Lampu Hias gantung (1 Pcs)",
      total: "Rp120.000",
      date: "05-05-2024 16:05",
      status: "Dibatalkan",
    },
    {
      id: "PSN006",
      customer: "Valensia",
      products: "Patung Pemujaan Kuno (1 Pcs)\nBoneka Seram (1 Pcs)",
      total: "Rp166.000",
      date: "16-09-2024 13:05",
      status: "Selesai",
    },
    {
      id: "PAN007",
      customer: "Bagus Yogi",
      products: "Kotak Musik Berhantu (3 Pcs)",
      total: "Rp90.000",
      date: "04-06-2024 16:58",
      status: "Selesai",
    },
  ];

  // Simplified product renderer
    const renderProducts = (productText: string | null): React.ReactNode => {
  ...
  return (
    <div className="flex min-h-screen bg-[#1e2a3e]">
      {/* Left Sidebar */}
      <div className="w-56 bg-red-900 border-r border-gray-800 shadow-sm flex flex-col fixed h-full">
        <div className="p-4">
            <h1 className={`text-4xl ${jollyLodger.className} mb-4`} style={{ WebkitTextStroke: "0.5px white" }}>
        ...
        <div className="p-5 mt-10">
          <div className="bg-gray-400 rounded shadow-lg overflow-hidden ">
              ...
              <div key={order.id} className="grid grid-cols-7 border-b border-gray-400 last:border-b-0 hover:bg-gray-200">
                ...
                <div className="p-4">
                  <button className="text-red-500">
                    ...
                    >
                      <rect width="33" height="33" fill="url(#pattern0_274_931)" />
                      <defs>
                        <pattern
                          id="pattern0_274_931"
                        ...
                        <image
                          ...
                          xlinkHref="data:image/png;base64,"
                        />
                      </defs>
                    </svg>
                  </button>
            ...
            <div className="p-4 flex justify-end items-center">
              <span className="text-gray-800 mr-4">Menampilkan 1-7 dari 140 produk</span>
              <div className="flex gap-2 items-center">
                <button className="px-3 py-1 border border-gray-600 rounded bg-white text-gray-800 hover:bg-gray-200">
