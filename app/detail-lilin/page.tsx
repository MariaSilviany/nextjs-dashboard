    ...
    <div className="min-h-screen bg-gray-900 pt-[130px] font-sans">
      ...
      <div className="bg-[#cbd5e1] text-black rounded-lg mx-auto my-8 p-8 max-w-5xl flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2">
          <h1 className={`text-4xl font-bold text-red-700 ${jollyLodger.className}`}>Lilin Aroma Misterius</h1>
          ...
          <p className="mt-6 text-justify leading-relaxed italic">
            Lilin ini bukan sekadar penerang. Saat dinyalakan, aroma pekatnya meresap ke ruang dan jiwa perpaduan rempah gelap, kayu bakar purba, dan jejak dupa dari altar kuno. Lilin ini diyakini dapat membangkitkan intuisi terdalam, membungkus ruangan dalam aura sunyi yang tidak biasa.
          </p>
          <p className="mt-4 text-justify leading-relaxed italic">
            Dirancang khusus untuk sesi meditasi ritual, pertunjukan teatrikal spiritual, pemotretan dengan nuansa horor, atau sekadar menemani malam penuh kontemplasi. Sumbu lilin yang berasap tipis menghasilkan gerakan bayangan misterius, seolah ada sesuatu yang turut hadir.
          </p>
          <div className="mt-6">
            <h2 className="text-2xl font-semibold mb-2 italic">Spesifikasi Produk:</h2>
            <div className="text-left space-y-2 italic">
                <p>Material: Lilin kedelai alami dengan esens herbal rahasia</p>
                <p>Warna:  Hitam pekat dengan percikan emas</p>
                <p>Ukuran: Tinggi 10 cm, diameter 6 cm</p>
                <p>Bonus: Kartu mantra singkat & simbol penyegel aroma</p>
                <p>Kegunaan: Properti teater, meditasi, pemotretan, altar pribadi, dan koleksi spiritual</p>
            </div>
            </div>
        </div>
      </div>
